...
public class TestFileStream {
	...
	public void testFileInputWriteStream() throws IOException {
		...
		OutputDataStream<Integer> out = new 
				FileOutputIntegerStream("test6.txt", 100);
		
		out.write(memoryStream);
		out.close();
		memoryStream.close();		
	}
	...
	public void testFileStream2Stream() throws IOException {
		...
		OutputDataStream<Integer> out = new 
				FileOutputIntegerStream("test7.txt", 100);
		...
		InputDataStream<Integer> inputStream = 
				new FileInputIntegerStream("test7.txt", 20);
